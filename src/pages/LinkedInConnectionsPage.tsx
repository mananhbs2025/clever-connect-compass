...
// Define the Connection interface to match the User_Connections table
...
const LinkedInConnectionsPage = () => {
  ...
  // Fetch User_Connections table data for the current user
  const {
    data: connections,
    ...
    queryFn: async () => {
      ...
      // Query the User_Connections table for the current user
        ...
        <Card>
          ...
          <CardContent>
            {isLoadingConnections || isAssigningConnections ? (
              ...
              <EmptyConnectionsState onOpenImportModal={() => {
                assignConnectionsToUser();
